                    ...
                    <div class="col-lg">
                        <div class="card">
                            ...
                            <div class="card-body avatar-list">
                                ...
                                <div class="avatar avatar-xxl" data-toggle="tooltip" data-placement="top" title="Daniel G.">
                                    <img src="<c:url value="/assets/images/256_daniel-gaffey-1060698-unsplash.jpg" />"alt="Avatar" class="avatar-img rounded">
                                </div>
                                ...
                                <div class="avatar avatar-lg" data-toggle="tooltip" data-placement="top" title="Luke P.">
                                    <img src="<c:url value="/assets/images/256_luke-porter-261779-unsplash.jpg" />"alt="Avatar" class="avatar-img rounded">
                                </div>
                                ...
                                <div class="avatar" data-toggle="tooltip" data-placement="top" title="Luke P.">
                                    <img src="<c:url value="/assets/images/256_s-a-r-a-h-s-h-a-r-p-764291-unsplash.jpg" />"alt="Avatar" class="avatar-img rounded">
                                </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body avatar-list">
                                ...
                                <div class="avatar avatar-xxl avatar-4by3" data-toggle="tooltip" data-placement="top" title="Jeremy B.">
                                    <img src="<c:url value="/assets/images/256_jeremy-banks-798787-unsplash.jpg" />"alt="Avatar" class="avatar-img rounded">
                                </div>
                                <div class="avatar avatar-xl avatar-4by3" data-toggle="tooltip" data-placement="top" title="Andy L.">
                                    <img src="<c:url value="/assets/images/256_rsz_1andy-lee-642320-unsplash.jpg" />"alt="Avatar" class="avatar-img rounded">
                                </div>
