...
<body class="layout-login">
    ...
    <div class="layout-login__form bg-white" data-perfect-scrollbar>
        <div class="d-flex justify-content-center mt-2 mb-5 navbar-light">
            <a href="<c:url value="<%=urlUtil.URL_DASHBOARD %>" />" class="navbar-brand" style="min-width: 0">
        ...
        <form action="<c:url value="<%=urlUtil.URL_LOGIN %>" />" method="post">
            ...
            <div class="form-group text-center">
                ...
                <a href="<c:url value="<%=urlUtil.URL_DASHBOARD %>" />" >Forgot password?</a> <br> Don't have an account? <a class="text-body text-underline" href="<c:url value="<%=urlUtil.URL_SIGNUP %>" />">Sign up!</a>
            </div>
        </form>
    </div>
