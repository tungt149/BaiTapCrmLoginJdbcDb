    ...
    <div class="mdk-header__content">
        <div class="navbar navbar-expand-sm navbar-main navbar-dark bg-dark pr-0" id="navbar" data-primary>
            <div class="container">
                ...
                <!-- Navbar Brand -->
                <a  href="<%=request.getContextPath() + urlUtil.URL_DASHBOARD%>"class="navbar-brand">
                ...
                <ul class="nav navbar-nav d-none d-sm-flex border-left navbar-border navbar-height align-items-center">
                    <li class="nav-item dropdown">
                        ...
                        <div id="account_menu" class="dropdown-menu dropdown-menu-right">
                            ...
                            <a class="dropdown-item active" href="<c:url value="<%=urlUtil.URL_DASHBOARD %>" />">
                                Dashboard
                            </a>
                            <a class="dropdown-item" href="<c:url value="<%=urlUtil.URL_PROFILE %>" />"> 
                                My profile
                            </a>
                            <a class="dropdown-item" href="<c:url value="<%=urlUtil.URL_ACCOUNT_EDIT %>" />">
                                Edit account
                            </a>
                            <div class="dropdown-divider"></div>
                            <a class="dropdown-item" href="<c:url value="<%=urlUtil.URL_LOGIN %>" />">Logout</a>
                        </div>
                    </li>
                </ul>
            </div>
